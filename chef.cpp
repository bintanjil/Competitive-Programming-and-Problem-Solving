...
bool canFormPalindromes(string &A, string &B, int N) {
    ...
    if (N % 2 == 0) {
        return (cnt0 % 2 == 0 && cnt1 % 2 == 0 && cnt2 % 2 == 0);
    } else {
        return ((cnt0 % 2 + cnt1 % 2 + cnt2 % 2) == 1);
    }
}
...
int main()
{
    ...
    while(t--)
    {
        ...
        cout << (canFormPalindromes(A, B, N) ? "YES" : "NO") << endl;
    }
    return 0;
}
